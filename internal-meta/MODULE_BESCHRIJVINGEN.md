...
*   **01-ai-levenscyclus.md**: Overzicht van de 5 fasen van AI projecten (Ontdekking t/m Monitoring).
*   **02-hybride-methodologie.md**: Integratie van Waterfall (voor mijlpaalplanning) en Agile (voor executie).
*   **03-governance-model.md**: Frameworks voor besluitvorming, rollen en verantwoordelijkheden.
*   **04-agile-antipatronen-niet-toegestaan.md**: "NOT DONE" lijst met antipatronen die AI projecten belemmeren.
*   **05-project-initiatie.md**: Formele startfase (PMI Initiating), inclusief charter en stakeholder management.
...
*   **01-definitie.md**: Conceptuele uitleg van AI-Native Software Development.
*   **02-normatieve-criteria.md**: De C1-C7 entry criteria voor AI-Native projecten.
*   **03-artefact-model.md**: Documentatie van Intent, Constraints, Context, Change Set, Evidence, Trace Links.
*   **04-validatie-model.md**: Drie lagen van validatie: Syntactisch, Gedrag en Intent-Alignment.
*   **05-risicoclassificatie.md**: Risiconiveaus (Laag t/m Kritiek) in lijn met de EU AI Act.
...
*   **01-mloops-standaarden.md**: Richtlijnen voor CI/CD in machine learning.
*   **02-data-pipelines.md**: Architectuur voor schaalbare en betrouwbare dataverwerking.
*   **03-model-governance.md**: Beheer van modelversies en meta-data.
...
*   **01 t/m 05**: Standaard PMI templates (Charter, Business Case, Risks, Gates, Lessons Learned).
*   **06-ai-native-artefacten/**: Templates voor Intent, Constraints en Context.
...
*   **10.01-10.03**: Agile verbetercycli (Retros, Kaizen, Dashboards).
*   **11.01-11.03**: Formele afronding, overdracht en analyse van batenrealisatie.

## Specifieke Roadmaps & Tracks (12 t/m 15)
*Focus: Strategische executie en organisatie-transformatie.*

*   **12-90-dagen-roadmap**: Drie fasen (Focus, Pilot, Scale) voor snelle AI adoptie.
*   **13-organisatieprofielen**: Definities van volwassenheid (Verkenner, Piloot, Expert).
*   **14-drie-tracks**: De gelijktijdige aanpak van Strategie, Operations en Bedrijfsmodel.
*   **15-accelerators**: Gereedschapsets om de transformatie in de drie tracks te versnellen.
