...
# Identify emojis using hex codes to avoid script corruption
...
$cleanup = [ordered]@{
    ...
    "(?m)^\*\*Status:\*\*\s*(Definitief|Final)" = "**Status:** Draft"
}

Write-Host "Starting robust restoration and status update..."
