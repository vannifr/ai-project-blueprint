...
### 2.1 Elk Model Heeft Een Eigenaar
...
### 2.3 Geen Wijziging Zonder Review
...
### 3.1 Minimale Metadata per Model
...
### 4.1 Standaard Flow (Beperkt Risico)
...
### 4.2 Uitgebreide Flow (Hoog Risico)
