...
!!! abstract "Doel"
    Definitieve meting van de beloofde baten bij projectafsluiting, met rapportage aan de stuurgroep en overdracht van het waarderealisatieplan.

## 1. Doelstelling

Wij meten bij projectafsluiting de definitieve realisatie van de beloofde baten, rapporteren hierover aan de stuurgroep en dragen het waarderealisatieplan over aan de beheerorganisatie voor voortgezette bewaking.
...
### Overdracht Waarderealisatieplan

Het waarderealisatieplan wordt overgedragen aan de eigenaar in de beheerorganisatie:

1. Overzicht van alle baten-KPI's met definitie en meetmethode.
1. Kwartaalreviewschema (zie [Waarderealisatie — Operationeel](../10-doorlopende-verbetering/04-batenrealisatie.md)).
1. Contactpersoon voor escalatie bij structurele batenachterstand.

### Slotrapportage aan stuurgroep

De AI PM presenteert de waarderealisatie in een slotrapportage (max. 10 slides of 3 A4):
...
| Beheerorganisatie eigenaar | Accepteert het waarderealisatieplan voor voortgezette bewaking | R       |
...
- [ ] Waarderealisatieplan is overgedragen aan de beheerorganisatie.
...
| Waarderealisatieplan (overdracht) | Plan voor voortgezette bewaking door beheerorganisatie | AI PM                  |
