...
# 2.1.2 Opleveringen & Gate 1 (Go/No-Go Ontdekking) (Verkenning & Strategie)

## 2.1.2.1 Opleveringen (Afleveringen)
...
## 2.1.2.2 Gate 1 (Go/No-Go Ontdekking) Review Checklist
...
## 2.1.2.3 Gerelateerde Sjablonen
