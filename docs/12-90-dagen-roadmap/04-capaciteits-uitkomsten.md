...
!!! abstract "Doel"
    Beschrijving van de competenties en capaciteiten die na de 90-dagen-roadmap op elk organisatieniveau zijn opgebouwd.
...
| **Risicobewustzijn** | De eerste Harde Grenzen zijn gedefinieerd en getest in de pilot.                             |
...
| Gedefinieerde Harde Grenzen           | Geen        | Concept      | Formeel vastgesteld  |
