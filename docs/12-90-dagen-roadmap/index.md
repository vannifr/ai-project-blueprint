...
*   **Het Kostenplaatje:** Breng de huidige AI-uitgaven (licenties, cloud) in kaart.
...
```mermaid
gantt
    title 90-Dagen Startplan
    dateFormat  X
    axisFormat Dag %x
    
    section Maand 1: Focus
    Audit & Rationalisatie      :0, 15
    Strategie & Selectie        :10, 30
    
    section Maand 2: Pilot
    Praktijkproef Bouwen        :30, 50
    Proces Herontwerp           :35, 55
    User Testing                :50, 60
    
    section Maand 3: Schaal
    Standaardisatie             :60, 80
    Governance & Uitrol         :70, 90
```
