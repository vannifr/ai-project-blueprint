...
type: faq
layer: 1
answers: [Wat is Veelgestelde Vragen (FAQ)?]
---
...
| Validatie (PoV)         | Nauwkeurigheid vs. baseline, latentie (p95 = het 95e percentiel; 95% van de verzoeken is sneller dan deze waarde), kosten per voorspelling | [Experiment Ticket](../09-sjablonen/17-experiment-ticket/template.md), [Gate Reviews](../09-sjablonen/04-gate-reviews/checklist.md) |
| Realisatie              | Testdekking, integratiescore, naleving Harde Grenzen                                                                                       | [SDD Patroon](../04-fase-ontwikkeling/05-sdd-patroon.md)                                                                            |
...
| Beheer & Optimalisatie  | Prestatieverloop-indicatoren, business impact, hallucinatiepercentage                                                                      | [Drift Detectie](../06-fase-monitoring/05-drift-detectie.md), [Model Health Review](../09-sjablonen/18-modelgezondheid/template.md) |
...
## 2. Wat voor inschattingen hebben we nodig in AI-projecten?
