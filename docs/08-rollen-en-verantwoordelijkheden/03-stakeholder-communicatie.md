...
| Guardian         | Compliance-status, rode lijnen, risico-updates | Maandelijks   | Schriftelijk rapport        | AI PM + Tech Lead |
...
- **Organiseer regelmatige health reviews.** Gebruik het [Maandelijkse Modelgezondheidsreview](../09-sjablonen/18-modelgezondheid/template.md) sjabloon om structureel transparantie te bieden.
...
> "Het AI-systeem \[naam\] is tijdelijk gepauzeerd vanwege een overschrijding van de rode lijnen op \[datum\]. Het incidentresponsteam onderzoekt de oorzaak. Verwachte doorlooptijd: \[schatting\]. Wij communiceren updates elke \[frequentie\] via \[kanaal\]."
...
**Volgende stap:** Gebruik het [Maandelijkse Modelgezondheidsreview](../09-sjablonen/18-modelgezondheid/template.md) sjabloon voor gestructureerde stakeholdercommunicatie en raadpleeg de [Besluitvormingsmatrix](besluitvormingsmatrix.md) voor beslissingsbevoegdheden per rol.
