...
type: index
layer: 1
summary: Overview of all roles in an AI project and their responsibilities per lifecycle phase.
answers: [What does the Roles & Responsibilities section contain?, What roles do I need?]
---
