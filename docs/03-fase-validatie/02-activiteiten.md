...
# 2.2.1 Kernactiviteiten & Rollen (Validatie)

## 2.2.1.1 Kernactiviteiten

### 2.2.1.1.1 Praktijkproef (Proof of Value)
...
### 2.2.1.1.2 Betrouwbaarheidstesten
