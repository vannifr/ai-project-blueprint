...
Collection page for reference material, sources and supplementary appendices to the AI Project Blueprint.

______________________________________________________________________

## Contents

- **[Glossary](../termenlijst/index.md):** Definitions of all core terms in the Blueprint.
- **[Method Index](../00-strategisch-kader/08-blueprint-methodologie.md):** Full index of the Blueprint methodology.
- **[Sources & Inspiration](../16-bronnen/index.md):** Primary sources, standards and references.
- **[Changelog](../release-notes.md):** Version history and changes.
