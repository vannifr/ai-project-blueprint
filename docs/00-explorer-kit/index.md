...
## 3. De 30-Dagen Structuur op Hoofdlijnen

```
Week 1 — Fundament
├── Dag 1–2: Project Charter Light invullen
├── Dag 3–4: Risk Pre-Scan Quick uitvoeren
└── Dag 5:   Team samenstellen & rollen toewijzen

Week 2 — Verkenning
├── Dag 6–8: Data-evaluatie (checklist)
...
Week 4 — Beslissing
├── Dag 18–20: Validatierapport Minimaal invullen
├── Dag 21:   Gate 1 Review
└── Dag 22–30: Iteratie of gefundeerd stopzetten
```
...
Voordat u start, controleer het volgende:
...
**Stap 1.** Lees het [30-Dagen Plan](01-30-dagen-plan.md) volledig door (30 minuten).
...
| Metriek                            | Streefwaarde          |
| :--------------------------------- | :-------------------- |
| Tijd tot werkend prototype         | \< 25 dagen           |
| Gate 1 Review gereed op dag 21     | 100%                  |
| Validatie op 20 testcases          | ≥ 80% kwaliteitsscore |
| Beslissing Go/No-Go gedocumenteerd | Altijd                |
...
- [Fase 2: Validatie (Praktijkproef)](../03-fase-validatie/01-doelstellingen.md)
