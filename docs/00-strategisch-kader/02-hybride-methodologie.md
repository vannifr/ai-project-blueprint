...
gantt
    ...
    Strategie & Planning     :p1, 2024-01-01, 2w
    Budget & Governance      :p2, after p1, 1w
    section Iteratief
    Sprints 1-4             :s1, after p2, 4w
    Sprints 5-8             :s2, after s1, 4w
    section Voorspelbaar
    Milestone Review         :m1, after s2, 1w
    section Iteratief
    Sprints 9-12            :s3, after m1, 4w
```
...
*   **Compliance:** Geïntegreerde EU AI Act compliance reviews.
