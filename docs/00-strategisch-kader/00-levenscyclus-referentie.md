...
| **2 — Validatie (PoV)**        | Hypothese testen op kleine schaal, ROI onderbouwen    | Gate 2: Investeringsbeslissing | Proof of Value uitvoeren + Business Case          | [Validatierapport](../09-sjablonen/07-validatie-bewijs/validatierapport.md) |
