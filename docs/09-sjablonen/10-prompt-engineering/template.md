...
# 4.10 Prompt Engineering Sjabloon
...
## 4.10.2 Structuur van een Top-Prompt

### 4.10.2.1 Context (De achtergrond)
...
### 4.10.2.3 Sturingsinstructies (Kennis & Regels)
...
### 4.10.2.4 Rode Lijnen (Constraints)
...
### 4.10.2.5 Output Format (De vorm)
